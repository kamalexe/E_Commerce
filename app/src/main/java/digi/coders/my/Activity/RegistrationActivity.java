...
public class RegistrationActivity extends AppCompatActivity {
    ...
    public void signup(View view) {
        ...
        if (userPassword.length() < 8) {
            Toast.makeText(this, "Password too short enter minimum 8 charaxters !", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        auth.createUserWithEmailAndPassword(userEmail, userPassword).addOnCompleteListener(RegistrationActivity.this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(RegistrationActivity.this, "isSuccessfully Registration", Toast.LENGTH_SHORT).show();
